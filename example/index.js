...
import {SendLocationView, showSendLocation} from "../src/SendLocation";
...
export default class Example extends React.Component {
    ...
    render() {
        return <View style={{flex: 1, justifyContent: "center", alignItems: "center"}}>
            ...
            <TouchableOpacity onPress={() => showSendLocation(this.onSelect.bind(this))}>
                <Text style={styles.btn}>选择位置2</Text>
            </TouchableOpacity>
